...
<div class="p-8 space-y-6 max-w-[1200px]">
	<div>
		...
		<p class="text-[13px] mt-0.5" style="color: var(--text-tertiary);">GPU interconnect bandwidth matrix</p>
	</div>
			...
			<div class="rounded-lg p-5" style="background: var(--bg-secondary); border: 1px solid var(--border);">
				...
				<div class="space-y-1">
					{#each topo.links as link}
						<div class="flex items-center gap-3 py-2 px-3 rounded-md transition-colors"
